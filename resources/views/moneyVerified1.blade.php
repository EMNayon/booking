...
<body>
    <section class="container" >
        ...
        <span class="bin">BIN : {{ $member->bin_no }}</span>
        <span style="margin-left: 550px;">
            <a class="btn btn-sm btn-info text-white" href="{{ route('money_receipt', [$member->code]) }}">Download PDF</a>
        </span>


        <div class="money-receipt" style="text-align: center">
            <p class="money-receipt-name" style="text-align: center;">MONEY RECEIPT</p>
