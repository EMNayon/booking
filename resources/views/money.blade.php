    ...
    <div class="container" style="max-width: 1000px;">
        <div class="row text-center mb-5">
            <div class="col-sm-12 pt-3">
                <img src="	https://um.pe/get-logo/mercantile" alt="Company Logo" class="img img-responsive"
                    width="100%">
            </div>
            <div class="col-sm-12">
        ...
        <div class="pe-3">
            ...
            <div class="row py-4">
                <div class="col-sm-12 col-md-6">
                    <div class="row no-gutters">
                        <div class="col-5 d-inline-block">Issuing Office</div>
            ...
            <div class="row ">
                ...
                <div class="col b_bottom d-inline-block">
            ...
            <div class="row  mb-2">
                ...
                <div class="col-10 b_bottom d-inline-block">
...
<body oncontextmenu="return false;" onload="showModal()" style="background: whitesmoke;" cz-shortcut-listen="true">
    <div class="container-fluid" style="max-width: 1000px; background: #fff;">
        <div class="row text-center mb-5">
            <div class="col-sm-12 pt-3">
