        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    return "<a class='btn btn-sm btn-primary' href='" . route('member_edit', [$row->code]) . "'>View/Edit</a> <a class='btn btn-sm btn-info text-white' href='" . route('print_wecare', [$row->code]) . "'>Download Wecare</a> <a class='btn btn-sm btn-info text-white' href='" . route('print_travelvisit', [$row->code]) . "'>Download TravelVisit</a>"
